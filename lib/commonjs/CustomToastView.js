...
exports.CustomToastView = void 0;
...
const CustomToastView = ({
  ...
  const bounceAnim = (0, _react.useRef)(new _reactNative.Animated.Value(0)).current;
  const animateOut = (0, _react.useCallback)(() => {
    const duration = 200;
    const preset = toast.animationPreset || 'slide';
    let animation;
    switch (preset) {
      case 'fade':
        animation = _reactNative.Animated.timing(fadeAnim, {
          toValue: 0,
          duration,
        ...
        break;
      case 'bounce':
        animation = _reactNative.Animated.parallel([_reactNative.Animated.timing(fadeAnim, {
          toValue: 0,
          duration,
          useNativeDriver: true
  ...
  const getAnimationIn = () => {
    ...
    switch (preset) {
      ...
      case 'bounce':
        return _reactNative.Animated.parallel([_reactNative.Animated.timing(fadeAnim, {
          toValue: 1,
          duration: duration / 2,
          useNativeDriver: true
        }), _reactNative.Animated.spring(bounceAnim, {
          toValue: 1,
          tension: 10,
          friction: 3,
          useNativeDriver: true
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.Animated.View, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.TouchableOpacity, {
      ...
      children: [children || /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.View, {
        style: styles.defaultContent,
        children: [toast.icon && typeof toast.icon === 'string' && /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.Text, {
          style: [styles.icon, {
        ...
        }), (toast.actions || (toast.action ? [toast.action] : [])).map((action, index) => /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.TouchableOpacity, {
          onPress: () => {
            action.onPress();
      ...
      }), toast.showProgressBar && toast.progress !== undefined && /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.View, {
...
exports.CustomToastView = CustomToastView;
